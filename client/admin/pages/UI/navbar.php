                    ...
                    <div class="row">
                      <div class="col-12 col-lg-6">
                        <h4 class="mt-4">
                          Primary Navbar
                          <small
                            ><b>recommended</b> (navbar-primary
                            navbar-dark)</small
                          >
                        </h4>
                        <nav
                          class="navbar navbar-expand navbar-primary navbar-dark"
                        >
                          <!-- Left navbar links -->
                          <ul class="navbar-nav">
                            <li class="nav-item">
                      ...
                      <div class="col-12 col-lg-6">
                        ...
                        <nav
                          class="navbar navbar-expand navbar-primary navbar-light"
                        >
                          <!-- Left navbar links -->
                          <ul class="navbar-nav">
                            <li class="nav-item">
                    ...
                    <div class="row">
                      <div class="col-12 col-lg-6">
                        <h4 class="mt-4">
                          Orange Navbar
                          <small
                            ><b>recommended</b> (navbar-orange
                            navbar-light)</small
                          >
                        </h4>
                        <nav
                          class="navbar navbar-expand navbar-orange navbar-light"
                        >
                          <!-- Left navbar links -->
                          <ul class="navbar-nav">
                            <li class="nav-item">
                      ...
                      <div class="col-12 col-lg-6">
                        ...
                        <nav
                          class="navbar navbar-expand navbar-orange navbar-dark"
                        >
                          <!-- Left navbar links -->
                          <ul class="navbar-nav">
                            <li class="nav-item">
