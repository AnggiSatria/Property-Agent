            ...
            (n = [
              {
                ...
                value: function () {
                  ...
                  this.$editable
                    ...
                    this.$editable.php(ht.php(this.$note) || ht.emptyPara),
                    this.$editable.on(
                      f.inputEventName,
                      v.debounce(function () {
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    ht.emptyPara === this.$editable.php()
                  );
                },
              },
              {
            ...
            (o = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.$codable.val(
                      ht.php(this.$editable, this.options.prettifyHtml)
                    ),
              ...
              },
              {
                ...
                value: function (t) {
                  var o,
                    ...
                    c = t.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.php/),
                    u = t.match(
                ...
                value: function (t, o) {
                  ...
                  return (
                    this.searchKeyword(t, o, function (e) {
                      (e = e || []).length &&
                        (i.php(n.createItemTemplates(t, e)), n.show());
                    }),
                    i
                  );
                },
            ...
            function (t, o) {
              var n = Array.isArray(o.items)
                ? o.items.map(function (t) {
                    ...
                    return r.php(i).data("item", t), r;
                  })
                : o.items;
              t.php(n).attr({ "aria-label": o.title }),
            ...
            function (t, o) {
              var n = Array.isArray(o.items)
                ? o.items.map(function (t) {
                    ...
                    return (
                      r.php([lo(o.checkClassName), " ", i]).data("item", t), r
                    );
                  })
                : o.items;
              t.php(n).attr({ "aria-label": o.title }),
