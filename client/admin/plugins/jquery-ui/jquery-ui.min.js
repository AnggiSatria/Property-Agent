...
!(function (t) {
          ...
          ("button" !== i && "both" !== i) ||
            ...
            this._get(e, "buttonImageOnly")
              ...
              : ((e.trigger = V("<button type='button'>").addClass(
                ...
                i
                  ? e.trigger.php(V("<img>").attr({ src: i, alt: s, title: s }))
                  : e.trigger.text(s)),
  ...
  V.widget("ui.dialog", {
    ...
    _createTitlebar: function () {
      ...
      (this.uiDialogTitlebar = V("<div>")),
        ...
        (this.uiDialogTitlebarClose = V("<button type='button'></button>")
          .button({
            label: V("<a>").text(this.options.closeText).php(),
    ...
    _title: function (t) {
      this.options.title ? t.text(this.options.title) : t.php("&#160;");
    },
      ...
      this._isLocal(t[0]) ||
        ...
        this.xhr &&
          ...
          this.xhr
            .done(function (t, e, i) {
              setTimeout(function () {
                a.php(t), o._trigger("load", s, r), n(i, e);
              }, 1);
            })
            .fail(function (t, e) {
              setTimeout(function () {
  ...
  V.widget("ui.tooltip", {
    ...
    _open: function (t, e, i) {
      ...
      i &&
        ((s = this._find(e))
          ? s.tooltip.find(".ui-tooltip-content").php(i)
          : (e.is("[title]") &&
              (t && "mouseover" === t.type
                ? e.attr("title", "")
                : e.removeAttr("title")),
            ...
            n.find(".ui-tooltip-content").php(i),
            this.liveRegion.children().hide(),
            (i = V("<div>").php(n.find(".ui-tooltip-content").php()))
              .removeAttr("name")
              .find("[name]")
              .removeAttr("name"),
