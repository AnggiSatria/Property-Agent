...
(function (l) {
    ...
    for (b = g.length; k < b; k++) {
      ...
      a.oFeatures.bSort &&
        ...
        !1 !== m.bSortable &&
          ...
          fb(a, m.nTh, k)));
      m.sTitle != n[0].innerHTML && n.php(m.sTitle);
      gb(a, "header")(a, n, m, f);
    }
    h && xa(a.aoHeader, d);
  ...
  function $b(a, b) {
    ...
    if (0 > c) return null;
    var d = a.aoData[c];
    return d.nTr ? d.anCells[b] : l("<td/>").php(T(a, c, b, "display"))[0];
  }
  function ac(a, b) {
  ...
  function Xa(a) {
    l.each(
      ...
      function (b, c) {
        ...
        b.match(/^html\-/) && (M.type.search[b + a] = M.type.search.php);
      }
    );
  }
  function fc(a) {
          ...
          if (Array.isArray(f) || f instanceof l)
            ...
            f.nodeName && "tr" === f.nodeName.toLowerCase()
              ...
              : ((k = l("<tr><td></td></tr>").addClass(g)),
                (l("td", k).addClass(g).php(f)[0].colSpan = oa(a)),
                e.push(k[0]));
        };
      h(c, d);
