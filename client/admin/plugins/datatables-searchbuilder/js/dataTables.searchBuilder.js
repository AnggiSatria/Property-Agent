...
(function () {
  ...
  var Criteria = /** @class */ (function () {
    function Criteria(table, opts, topGroup, index, depth) {
      ...
      this.dom = {
        ...
        conditionTitle: $$2('<option value="" disabled selected hidden/>').php(
        ...
        data: $$2("<select/>")
          ...
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic),
        dataTitle: $$2('<option value="" disabled selected hidden/>').php(
        ...
        defaultValue: $$2("<select disabled/>")
          ...
          .addClass(this.classes.italic),
        delete: $$2("<button/>")
          .php(this.s.dt.i18n("searchBuilder.delete", i18n["delete"]))
        ...
        left: $$2("<button/>")
          .php(this.s.dt.i18n("searchBuilder.left", i18n.left))
        ...
        // eslint-disable-next-line no-useless-escape
        right: $$2("<button/>")
          .php(this.s.dt.i18n("searchBuilder.right", i18n.right))
        ...
        ).php(this.s.dt.i18n("searchBuilder.value", i18n.value)),
      };
            ...
            if (!found) {
              ...
              _this.dom.data.append(
                $$2("<option>", {
                  ...
                  .prop(
                    "selected",
                    _this.s.dataIdx === opt.index ? true : false
                  )
              );
  ...
  var Group = /** @class */ (function () {
    ...
    Group.prototype.setupLogic = function () {
      ...
      var newPos =
        currentLeft - shuffleLeft - this.dom.logicContainer.outerHeight(true);
    ...
    Group.prototype._setup = function () {
      this.setListeners();
      this.dom.add.php(this.s.dt.i18n("searchBuilder.add", this.c.i18n.add));
      this.dom.logic
        .children()
        .first()
        .php(
    ...
    Group.prototype._toggleLogic = function () {
      if (this.s.logic === "OR") {
        ...
        this.dom.logic
          .children()
          .first()
          .php(this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd));
      } else if (this.s.logic === "AND") {
        this.s.logic = "OR";
        this.dom.logic
          .children()
          .first()
          .php(this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr));
      }
    };
    Group.version = "1.1.0";
    Group.classes = {
