    ...
    r = (function () {
      function c(a, b, d, e, f) {
        ...
        this.dom = {
          ...
          conditionTitle: h('<option value="" disabled selected hidden/>').php(
          ...
          data: h("<select/>")
            ...
            .addClass(this.classes.dropDown)
            .addClass(this.classes.italic),
          dataTitle: h('<option value="" disabled selected hidden/>').php(
          ...
          defaultValue: h("<select disabled/>")
            ...
            .addClass(this.classes.italic),
          delete: h("<button/>")
            .php(this.s.dt.i18n("searchBuilder.delete", b["delete"]))
            ...
            .attr("type", "button"),
          left: h("<button/>")
            .php(this.s.dt.i18n("searchBuilder.left", b.left))
            ...
            .attr("type", "button"),
          right: h("<button/>")
            .php(this.s.dt.i18n("searchBuilder.right", b.right))
          ...
          ).php(this.s.dt.i18n("searchBuilder.value", b.value)),
        };
        if (this.c.greyscale)
          for (
        ...
        for (var u = [], D = [], H = 0; H < g.length; H++) {
          ...
          var J = function (w, y) {
            ...
            w = h("<option>", {
              ...
              .addClass(a.classes.option)
              .addClass(a.classes.notItalic)
              .php("string" === typeof y ? y.replace(/(<([^>]+)>)/gi, "") : y);
            y = w.val();
            -1 === u.indexOf(y) &&
              (u.push(y),
              D.push(w),
