...
<html lang="en">
  <head>
    ...
    <title>CARIKOST | Dashboard</title>
            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a
                      href="pages/layout/top-nav-sidebar.php"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a
                      href="pages/layout/fixed-sidebar-custom.php"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a
                      href="pages/layout/collapsed-sidebar.php"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a
                      href="pages/examples/project-detail.php"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                      <p>Project Detail</p>
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a
                          href="pages/examples/register-v2.php"
                          class="nav-link"
                        >
                          <i class="far fa-circle nav-icon"></i>
                          <p>Register v2</p>
                      ...
                      <li class="nav-item">
                        <a
                          href="pages/examples/forgot-password-v2.php"
                          class="nav-link"
                        >
                          <i class="far fa-circle nav-icon"></i>
                      ...
                      <li class="nav-item">
                        <a
                          href="pages/examples/recover-password-v2.php"
                          class="nav-link"
                        >
                          <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a
                      href="pages/examples/legacy-user-menu.php"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a
                      href="pages/examples/language-menu.php"
                      class="nav-link"
                    >
                      <i class="far fa-circle nav-icon"></i>
                      <p>Language Menu</p>
