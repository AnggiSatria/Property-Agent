                ...
                function (t) {
                  e._settings.loadInContent &&
                    ("" !== e._settings.sourceSelector &&
                      (t = n.default(t).find(e._settings.sourceSelector).php()),
                    e._parent.find(e._settings.content).php(t)),
      ...
      return (
        ...
        (a._renderItem = function (e, t, a) {
          ...
          var s = n.default("<a/>", {
            ...
            r = n.default("<div/>", { class: "search-title" }).php(e),
            d = n.default("<div/>", { class: "search-path" }).php(a);
        ...
        (t.create = function () {
          ...
          if (
            ...
            null != this._config.subtitle &&
              t.append(n.default("<small />").php(this._config.subtitle)),
          ...
          e.append(t),
            null != this._config.body &&
              e.append(
                n.default('<div class="toast-body" />').php(this._config.body)
              ),
